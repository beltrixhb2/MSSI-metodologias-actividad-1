...
\textbf{Innovación y Mejora Continua (Hack Time):} Inspirados en la cultura de Spotify\cite{ejemplo2023} [\textit{Método Spotify}], se reserva la tarde de los martes de cierre de \textit{Sprint} (después de la \textit{Retrospective}, de 12:15 a 18:00) como un espacio flexible:
\begin{enumerate}
