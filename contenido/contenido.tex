...
\chapter{Artefactos clave: Product Backlog y Sprint Backlogs}
...
La \textit{Velocity} se calculará mediante la suma de \textit{Story Points} (SP) de todas las Historias de Usuario completadas. Un SP es una unidad para estimar tiempo, esfuerzo, complejidad e incertidumbre.
