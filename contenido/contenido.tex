...
\begin{figure}[H]
    ...
    \caption{Mapa de historias de usuario del usuario cliente del proyecto \textit{``Relatos de Papel''} construido con Featmap.}
...
\begin{figure}[H]
    ...
    \caption{Ejemplo de \textit{Burn-down chart}.}
